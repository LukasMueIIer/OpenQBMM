...
#include "steadyStateUnivariatePDFTransportModel.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::PDFTransportModels::steadyStateUnivariatePDFTransportModel
::steadyStateUnivariatePDFTransportModel
(
    const word& name,
...
void Foam::PDFTransportModels::steadyStateUnivariatePDFTransportModel::solve()
{
