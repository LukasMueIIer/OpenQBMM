...
#include "steadyStateUnivariatePopulationBalance.H"
...
{
    defineTypeNameAndDebug(steadyStateUnivariatePopulationBalance, 0);
    addToRunTimeSelectionTable
    (
        populationBalanceModel,
        steadyStateUnivariatePopulationBalance,
        dictionary
    );
}
}
...
Foam::PDFTransportModels::populationBalanceModels::steadyStateUnivariatePopulationBalance
::steadyStateUnivariatePopulationBalance
(
    const word& name,
...
:
    steadyStateUnivariatePDFTransportModel(name, dict, phi.mesh(), phi, "RPlus"),
...
::realizableCo() const
{
    return steadyStateUnivariatePDFTransportModel::realizableCo();
}
...
::solve()
{
    steadyStateUnivariatePDFTransportModel::solve();
}
